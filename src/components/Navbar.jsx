            ...
            <div className="mx-auto max-w-6xl h-16 px-6 grid grid-cols-[auto_1fr_auto] items-center">
                ...
                <div>
                    <ul className="justify-self-center flex items-center gap-6 font-bold whitespace-nowrap">
                        <li><a href="/sprzedaj" className="text-white hover:text-purple-300">SPRZEDAJ</a></li>
                        <li><a href="/kup" className="text-white hover:text-purple-300">KUP</a></li>
                        <li><a href="/bitwa" className="text-white hover:text-purple-300">BITWA</a></li>
                        <li><a href="/dziennaSkrzynka" className="text-white hover:text-purple-300">DZIENNA SKRZYNKA</a></li>
                    </ul>
                </div>
